...
const Landing = () => {
  ...
  return (
    <div className="px-6 md:px-12">
      ...
      {/* Stats Section */}
      <div className="flex flex-col md:flex-row justify-center md:justify-start gap-8 mt-16 text-center md:text-left">
      ...
      <div className="mt-20 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
            <FontAwesomeIcon
              icon={faUsers}
              className="text-primary-500 text-5xl mb-4"
            />
      ...
      {/* CTA Section */}
      <div className="m-20 bg-primary-500 text-white rounded-xl p-12 flex flex-col md:flex-row items-center justify-between">
        {/* Left Text */}
        <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
          ...
          <button
            ...
            className="bg-white text-primary-500 font-semibold px-8 py-3 rounded-lg hover:bg-gray-100 transition md:cursor-pointer"
          >
            Sign Up Today
          </button>
        </div>
